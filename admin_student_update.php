...
if (isset($_POST['submit_img'])) {
    ...
    if( in_array($imageFileType,$extensions_arr) ){
        ...
        if(move_uploaded_file($_FILES['file']['tmp_name'],$target_dir.$name)){
            ...
            // Convert to base64 
            $image_base64 = base64_encode(file_get_contents('img/students/'.$name));
            $image = 'data:img/'.$imageFileType.';base64,'.$image_base64;

            // Update Record
            $query2 = "UPDATE `students` SET `student_img`='$name' WHERE student_id='$student_id'";
            $query_run2 = mysqli_query($conn, $query2);

            if ($query_run2) {
                echo "<script> alert('Profile Image Successfully Updated.');
                window.location.href='admin_students.php';</script>";
            } 
            else {
                $cls="danger";
...
if (isset($_POST['submit'])) {
    ...
    $city=$_POST['city'];
    $zip=$_POST['zip'];
    $stu_uni_id=$_POST['stu_uni_id'];

    $error = "";
    $cls="";

        // Update Record
        $query2 = "UPDATE `students` SET firstname='$firstname',lastname='$lastname', email='$email',
        birthday='$birthday', gender='$gender', contact='$contact',stu_uni_id='$stu_uni_id',
        `address`='$address', city='$city', zip='$zip' WHERE student_id='$student_id'";
        $query_run2 = mysqli_query($conn, $query2);
        ...
        <div class="main">
            <div class="row">
                <div class="col-md-10" style="padding-bottom:0px;">
                    <h2 style="font-weight:600">Update Student Information</h2>
                    <p><a href="admin_home.php">Dashboard</a> / <a href="admin_students.php">Manage Students</a> / My
                        Profile</p>
                </div>
            ...
            <div class="row">
                <div class="col-md-4">
                    <div style="text-align:center;padding-bottom:50px;margin-top:70px;">
                        <div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="col-md-12" style="width: 200px; height: 200px;">
                                            <img src="img/students/<?php echo $student_img?>" width="100%" height="100%"
                                                style="text-align:center; margin-left:90px; object-fit:cover">
                                        </div>
                                        <div class="col-md-12" style="padding-top:20px;">
                                            <div class="d-flex justify-content-center"
                                                style="padding-top:10px; padding-left:90px;">
                                                <input type="file" name="file" id="file">
                                            </div>

                                            <div class="d-flex justify-content-center" style="padding-top:10px;">
                                                <button type="submit_img" name="submit_img" class="btn btn-success"
                                                    style="margin-left:0px;margin-top:20px"><i class="fa fa-edit"></i>
                                                    Update
                                                    Image</button>
                                            </div>
                                        </div>
                ...
                <div class="col-md-8">
                    <div style="text-align:center;padding-top:0px; padding-bottom:20px">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group" style="padding:15px">
                                            ...
                                            <input type="text" class="form-control" name="stu_uni_id" id="stu_uni_id"
                                                value="<?php echo $stu_uni_id ?>" placeholder="Student ID" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group" style="padding:10px">
                                            ...
                                            <input type="text" class="form-control" name="contact" id="contact"
                                                value="<?php echo $contact ?>" placeholder="contact">
