    ...
    <section class="d-flex">
        <div class="header d-flex flex-column flex-shrink-0 p-3 text-white bg-dark" style="width: 280px;">
            ...
            <ul class="nav nav-pills flex-column mb-auto">
                <li class="nav-item">
                    <a href="teacher_home.php" class="nav-link active" aria-current="page"
        ...
        <div class="main">
                            ...
                            <?php
                             ...
                             if($result){
                                 while($row=mysqli_fetch_assoc($result)){
                                        ...
                                        $sql1 = "SELECT sum(credit) as tcredit FROM courses where course_id = $course_id";
                                ...
                                ?>
                            <h1 style="font-family:poppins;color:black;"><?php echo $tcredit?></h1>
                            ...
                            <?php
                             ...
                             if($result){
                                 while($row=mysqli_fetch_assoc($result)){
                                        ...
                                        $sql1 = "SELECT * FROM class_students where class_id=$class_id";
                                        $result1 = mysqli_query($conn, $sql1);
                                        $row_cnt1 = $result1->num_rows;
                                    }
                                }
                                ?>
                            <h1 style="font-family:poppins;color:black;"><?php echo $row_cnt1?></h1>
            ...
            <div class="row" style="padding-top:50px;margin-bottom:80px;">
                <div class="col-md-12">
                    <div style="text-align:center;padding:30px 0px; height:500px;">
                        <div class="d-flex justify-content-between" style="padding: 0 0px">
                            <div>
                                <h3 style="font-size:24px;padding-bottom:20px">Recently Assigned Courses</h3>
                            </div>
                            <div>
