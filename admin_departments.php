...
if (isset($_POST['submit'])) {
    ...
    $dep_init = $_POST['dep_init'];

    $query = "SELECT * FROM departments WHERE `dep_name` = '$dep_name' And `dep_init` = '$dep_init'";
    $query_run = mysqli_query($conn, $query);

    if (!$query_run->num_rows > 0) {
        $query2 = "INSERT INTO departments(dep_name, dep_code, dep_init)
        VALUES ('$dep_name','$dep_code','$dep_init')";
    ...
    <section class="d-flex">
        <div class="header d-flex flex-column flex-shrink-0 p-3 text-white bg-dark" style="width: 280px;">
            ...
            <ul class="nav nav-pills flex-column mb-auto">
                ...
                <li>
                    <a href="admin_departments.php" class="nav-link active" aria-current="page"
        ...
        <div class="main">
            <div class="row">
                <div class="col-md-10" style="padding-bottom:0px;">
                    <h2 style="font-weight:600">Manage Departments</h2>
                    <p><a href="admin_home.php">Dashboard</a> / Departments</p>
                </div>
                                ...
                                <tbody style="font-size:18px">
                                    ...
                                    <tr style="vertical-align:middle;">
                                        ...
                                        <td style="font-size:14px; font-weight:600;"><a
                                                href="admin_department_delete.php?dep_id=<?php echo $dep_id?>"
                    ...
                    <div class="modal-body">
                        <form action="" method="POST">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group" style="padding:10px">
                                        <label style="padding-bottom:10px;">Depatment Initial</label>
                                        <input type="text" class="form-control" name="dep_init" id="dep_init"
                                            placeholder="Department Initial" required>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group" style="padding:10px">
                                        <label style="padding-bottom:10px;">Depatment Code</label>
                                        <input type="text" class="form-control" name="dep_code" id="dep_code"
                            ...
                            <div class="d-flex justify-content-end" style="padding-top:10px;">
                                <button type="submit" name="submit" class="btn btn-success"
                                    style="margin-right:10px;margin-top:20px;">Add Depatment</button>
                            </div>
                        </form>
                    </div>
                </div>
